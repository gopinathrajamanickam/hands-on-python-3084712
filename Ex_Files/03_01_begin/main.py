...
# Disctionary data structure looks similar to JSON
EINSTEIN = {
    "birthplace": "Germany",
    "name": "Albert",
    "surname": "Einstein",
...
# with clause will not leave the file in read or write mode after it is processed
...
for laureate in laureates:
    if laureate["surname"] == "Einstein":
        ...
        print(laureate) # normal print does not print a readable output
        break
